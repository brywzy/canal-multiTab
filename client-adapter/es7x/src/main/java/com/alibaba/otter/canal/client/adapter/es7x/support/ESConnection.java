...
public class ESConnection {
    ...
    public class ES7xUpdateRequest implements ESBulkRequest.ESUpdateRequest {
        ...
        public ES7xUpdateRequest setRefreshPolicy(WriteRequest.RefreshPolicy refreshPolicy) {
            if (mode == ESClientMode.TRANSPORT) {
                updateRequestBuilder.setRefreshPolicy(refreshPolicy);
            } else {
    ...
    public class ES7xBulkRequest implements ESBulkRequest {
        ...
        public ES7xBulkRequest setRefreshPolicy(Object refreshPolicy) {

            if (mode == ESClientMode.TRANSPORT) {
                bulkRequestBuilder.setRefreshPolicy((WriteRequest.RefreshPolicy)refreshPolicy);
            } else {
