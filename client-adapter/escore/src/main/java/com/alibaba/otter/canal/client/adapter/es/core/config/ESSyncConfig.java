...
public class ESSyncConfig implements AdapterConfig {
    ...
    public static class ESMapping implements AdapterMapping {
        ...
        private String sqlConditionFiled;
        ...
        public String getSqlConditionFiled() {
            return sqlConditionFiled;
        }

        public void setSqlConditionFiled(String sqlConditionFiled) {
            this.sqlConditionFiled = sqlConditionFiled;
        }
        ...
        public Map<String, List<String>> getSecondaryTabRelation() {
            return secondaryTabRelation;
        }

        public void setSecondaryTabRelation(Map<String, List<String>> secondaryTabRelation) {
            this.secondaryTabRelation = secondaryTabRelation;
        }
    }
